...
import { ValuePredictionDistributionDataPoint } from "@/lib/mock-data-customer-value-forecast"

interface Props {
  data: ValuePredictionDistributionDataPoint[]
}
  ...
  if (active && payload && payload.length) {
    return (
      <div className="bg-white border border-slate-200 p-3 rounded-lg shadow-enterprise-md text-sm">
        <p className="font-medium text-slate-800 mb-1">Value: {label} EUR</p>
        <p className="text-purple-600 font-semibold">
          {new Intl.NumberFormat("en-US").format(payload[0].value)} records
        </p>
      </div>
    )
  }
        ...
        <ResponsiveContainer width="100%" height={300}>
          ...
          >
            ...
            <XAxis
              ...
              label={{
                value: "Customer value prediction",
